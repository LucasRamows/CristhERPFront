...
export interface DatesModelProps {
  onConfirm: (product: ProductsResponse) => void;
  product: ProductsResponse;
}

export const DatesModel = ({ onConfirm, product }: DatesModelProps) => (
  <>
    <button
...
export interface PdvRenderDatePickerProps {
  ...
  onConfirm: (product: ProductsResponse, options?: any) => void;
  product: ProductsResponse;
  isSyncing: boolean;
}

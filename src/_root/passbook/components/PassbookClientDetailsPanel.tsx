...
import { ViewCartReceiptSheet } from "../../../_features/receipt/sheet/ViewCartReceiptSheet";
...
export function PassbookClientDetailsPanel({
  ...
  return (
    ...
    >
                    ...
                    transactions.map((tx) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between sm:contents">
                          ...
                          <span
                            className={`font-bold text-lg sm:col-span-2 sm:text-right ${
                              tx.type === "DEBT"
                                ? "text-destructive"
                                : "text-green-500"
                            }`}
                        ...
                        <Button
                          size="icon"
                          disabled={!tx.orderId || isLoadingOrder}
                          onClick={() => {
                            handleViewNote(tx.orderId);
                          }}
                          className="sm:col-span-1 sm:justify-self-center"
                        >
                          <Eye size={16} />
                        </Button>
                      </div>
      ...
      {/* TICKET DO PEDIDO (MODO RECIBO/IMPRESSÃO) */}
      <ViewCartReceiptSheet
        ...
        timestamp={selectedOrder?.sale_date}

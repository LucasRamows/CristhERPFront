...
export function CreateSupplierSheet({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent
        side="right"
        className="w-[90%] sm:max-w-125 p-0 flex flex-col h-full bg-white dark:bg-zinc-950 border-l border-zinc-200 dark:border-zinc-800 outline-none [&>button]:hidden"
      >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-14 pl-12 pr-5 bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200/50 dark:border-zinc-800/80 rounded-xl focus:bg-white focus:border-primary outline-none transition-all font-semibold"
                />
              </div>
            </div>
            <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full h-14 px-5 bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200/50 dark:border-zinc-800/80 rounded-xl focus:bg-white focus:border-primary outline-none transition-all font-semibold appearance-none"
                >
                  <option>Geral</option>
        ...
        <div className="p-8 border-t border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 shrink-0">
          <button
            ...
            className="w-full h-16 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-[24px] font-black text-sm tracking-[0.2em] uppercase hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] hover:-translate-y-1 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:translate-y-0 shadow-2xl"
          >

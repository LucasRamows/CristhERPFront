...
export function XmlImport({
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto h-full flex flex-col justify-center animate-in fade-in slide-in-from-top-10 duration-500 pt-12 md:pt-20">
      {xmlState === "idle" && (
        <div onClick={onFileUpload} className="w-full relative group">
          <div className="absolute -inset-2 bg-linear-to-r from-emerald-500/20 to-primary/20 rounded-[50px] blur-2xl opacity-0 group-hover:opacity-100 transition-all duration-1000"></div>
          <div className="relative w-full border-4 border-dashed border-gray-200 bg-white/50 backdrop-blur-sm rounded-[44px] p-24 flex flex-col items-center justify-center text-center cursor-pointer hover:border-emerald-500/50 hover:bg-emerald-50/50 transition-all group-hover:scale-[1.02] shadow-sm">
            ...
            <p className="text-gray-400 font-bold text-xl max-w-sm leading-relaxed">
              Arraste o arquivo XML do seu fornecedor ou clique para selecionar.
              O sistema fará o cruzamento inteligente.
            </p>
          </div>
        </div>
      )}
      ...
      {xmlState === "success" && (
        <div className="bg-white rounded-[44px] border shadow-2xl overflow-hidden animate-in zoom-in-95 duration-500 max-w-3xl mx-auto border-t-8 border-emerald-500">
